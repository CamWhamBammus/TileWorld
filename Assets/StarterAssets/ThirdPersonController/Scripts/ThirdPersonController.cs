    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        private void CameraRotation()
        {
            ...
            if (_input.look.sqrMagnitude >= _threshold && !LockCameraPosition)
            {
                ...
                float look = Settings.LookSpeed;
                _cinemachineTargetYaw += _input.look.x * deltaTimeMultiplier * look;
                _cinemachineTargetPitch += _input.look.y * deltaTimeMultiplier * look;
            }
