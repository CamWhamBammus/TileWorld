...
public static class Fauna
{
    ...
    private static readonly Kind[] kinds =
    {
        ...
        new Kind
        {
            ...
            Lowest = 0f, Highest = 0.7f,
            Countries = new[] { Regions.Character.Dead, Regions.Character.Fungal, Regions.Character.Jungle },
            Roots = true,
        ...
        new Kind
        {
            ...
            Countries = new[] { Regions.Character.Lowland, Regions.Character.Forest, Regions.Character.Dead, Regions.Character.Jungle },
        ...
        new Kind
        {
            ...
            Lowest = 0f, Highest = 0.6f,
            KeepsOffSnow = true,
            Countries = new[] { Regions.Character.Lowland, Regions.Character.Forest, Regions.Character.Reed, Regions.Character.Fungal, Regions.Character.Hills, Regions.Character.Jungle },
        ...
        new Kind
        {
            ...
            Lowest = 0f, Highest = 0.6f,
            Countries = new[] { Regions.Character.Lowland, Regions.Character.Forest, Regions.Character.Water, Regions.Character.Reef, Regions.Character.Reed, Regions.Character.Jungle },
            Wades = 99f,
        ...
        new Kind
        {
            ...
            Lowest = 0f, Highest = 0.5f,
            KeepsOffSnow = true,
            Countries = new[] { Regions.Character.Lowland, Regions.Character.Forest, Regions.Character.Hills, Regions.Character.Jungle },
            Withdraws = true,
