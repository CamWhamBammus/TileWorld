...
public static class Landmarks
{
    ...
    private static readonly Kind[] kinds =
    {
        ...
        new Kind { Chance = 9, Name = "Sand Gate", Country = Regions.Character.Desert, Site = Site.Level,
                   ...
                   Where = "out in the sand, a gatehouse across the way with a court behind",
                   Behind = 5, Ahead = 3, Aside = 5, CoreHalf = 2, CoreVariation = 0.51f, ApronVariation = 1.0f },
        ...
        new Kind { Chance = 30, Name = "Fishing Jetty", Country = Regions.Character.Reed, Site = Site.Shore,
                   SurveyRadius = 3, SurveyHeight = 0f, LabelHeight = 6f,
        ...
        new Kind { Chance = 22, Name = "Stepped Altar", Country = Regions.Character.Stone, Site = Site.Level,
                   SurveyRadius = 6, SurveyHeight = 3.2f, LabelHeight = 12f,
                   Where = "on the bare rock, a stepped pyramid with a stone on top",
                   Behind = 4, Ahead = 6, Aside = 4, CoreHalf = 3, CoreVariation = 0.51f, ApronVariation = 1.0f },
        ...
        new Kind { Chance = 14, Name = "Toadstool Ring", Country = Regions.Character.Fungal, Site = Site.Level,
                   ...
                   Where = "in the damp woods, a ring of toadstools taller than a house round a shrine",
                   Behind = 5, Ahead = 5, Aside = 5, CoreHalf = 2, CoreVariation = 0.51f, ApronVariation = 1.0f },
